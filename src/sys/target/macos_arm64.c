...
void sys_entry(void) {
    __asm__ __volatile__ (
        ...
        //   x1 <- argv (char **)
        // why is dyld needed?
        // because the brilliant folks at XNU wrote this: https://github.com/apple-oss-distributions/xnu/blob/a1e26a70f38d1d7daa7b49b258e2f8538ad81650/bsd/kern/mach_loader.c#L861C2-L883C9
